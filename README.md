...
```text
bin\Release\Vwzhang.EnhancedAspireStarter.Templates.0.1.17.nupkg
```

## Install Locally

```powershell
dotnet new install .\bin\Release\Vwzhang.EnhancedAspireStarter.Templates.0.1.17.nupkg
```
...
```text
artifacts\vsix\EnhancedAspireStarter.VisualStudio.0.1.17.vsix
```
...
```powershell
.\scripts\Update-Template.ps1 -SourceRepository C:\Aspire\Starter -TemplateVersion 0.1.17
```
...
```powershell
dotnet new install .\bin\Release\Vwzhang.EnhancedAspireStarter.Templates.0.1.17.nupkg --force
